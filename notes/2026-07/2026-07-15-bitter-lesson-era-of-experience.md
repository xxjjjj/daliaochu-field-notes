...
## 12. 人话版：它不是反对经验，而是反对把人的经验当成天花板

这篇论文容易让人觉得矛盾：一边说人的经验不可靠，一边又说要学习、要经验。更准确的理解是：它反对的不是“经验”本身，而是反对把人类已有经验硬塞进系统，并让这些经验变成系统探索的边界。

可以用一个学徒做菜的例子理解：

- 错误做法：师傅把自己二十年的做菜口诀全部写死，学徒只能按口诀做。短期很稳，但永远只能做到师傅见过的水平。
- 更好的做法：师傅给学徒厨房、食材、安全规则、评价标准，让他大量试菜、尝味道、看客人反馈、复盘失败。这样学徒会继承经验，但也可能试出师傅没想到的新做法。

Sutton 说的“苦涩”就在这里：人类很爱当那个把口诀写死的师傅，因为这显得自己懂、也短期有效。但历史上很多真正突破，来自让系统自己搜索、自己学习，而不是只照搬人的口诀。

对 Agent 设计的借鉴意义：

1. 人类经验要做成边界、目标、评价标准和安全护栏，不要全部写成固定答案。
2. Agent 要有可探索的空间，比如能查资料、试方案、调用工具、比较结果。
3. Agent 要有反馈闭环，比如任务是否完成、用户是否采纳、错误在哪里、下次如何避免。
4. 经验沉淀不是把群聊原文或 SOP 全塞进去，而是沉淀“什么场景、怎么判断、结果如何、下次怎么改”。

所以这篇论文对企业 AI 的现实意义不是“不要业务经验”，而是提醒我们：业务经验应该帮助 Agent 少犯危险错误、知道什么叫好结果；但不能把 Agent 锁死在人的旧经验里，否则它只会变成一个更会背 SOP 的机器人。
